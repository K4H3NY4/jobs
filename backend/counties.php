...
if(isset($_POST['add-county'])){

    $county = mysqli_real_escape_string($db, $_POST['county']);

    
    $sql = "INSERT INTO `counties` SET  `county`= '$county' ";
...
$queryProfs = "SELECT * FROM `counties` ORDER by `id` DESC";
...
if(isset($_POST['delete'])){
    ...
    $sql = " DELETE FROM `counties` WHERE `id` = '$delete_id'";
                        ...
                        <div class="row">
                            <div class="col-10 offset-1">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Counties Listed</h4>
    ...
    <button class="btn  btn-success ml-3" name="add-county">Submit</button>
                   ...
                   <table id="datatable" class="table table-hover dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                       ...
                       <?php foreach ( $profs as $prof ):  ?>
                           ...
                           <td class="text-uppercase"><?php echo $prof['id']; ?></td>
