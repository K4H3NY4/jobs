...
$queryProfs = "SELECT * FROM `service_rate` ORDER by `id` DESC";
                        ...
                        <div class="row">
                            <div class="col-10 offset-1">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Service Charge</h4>
...
>>>>>>> b888daa3ab3d6c7880f7e4f17cc79861e3914f2c
                   ...
                   <table  class="table table-hover dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                       ...
                       <?php foreach ( $profs as $prof ):  ?>
                           <tr>
                           <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" class="form-inline mb-3 offset-1">                       
