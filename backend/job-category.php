...
$queryProfs = "SELECT * FROM `task_category` ORDER by `id` DESC";
...
if(isset($_POST['delete'])){
    ...
    $sql = " DELETE FROM `task_category` WHERE `id` = '$delete_id'";
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-10 offset-1">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Job Categories</h4></h4>
                        ...
                        <div class="row">
                        <br>
                                        <form action="../job-category.php" method="post" class="form-inline mb-3 offset-1" enctype="multipart/form-data" >
                   ...
                   <table id="datatable" class="table table-hover dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                       ...
                       <?php foreach ( $profs as $prof ):  ?>
                           <tr>
                            ...
                            <td class="text-capitalize"><?php echo $prof['category']; ?></td>    
                            <td >
