...
$queryProfs = "SELECT * FROM `withdraw` ORDER by `id` DESC";
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Withdraw Requests</h4>
                   ...
                   <table id="datatable" class="table table-hover dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                       ...
                       <?php foreach ( $profs as $prof ):  ?>
                           ...
                           <input type="hidden" name="update_id" value="<?php echo $prof["id"]; ?>">
                               ...
                               <td><?php echo $prof['service-charge']; ?></td>
                               <td><?php echo $prof['receive']; ?></td>
