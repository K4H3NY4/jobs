...
$queryjobs = "SELECT * FROM `tasks` WHERE `customer-id`= '$id'  ORDER by `id`DESC";
...
$querydeposits = "SELECT * FROM `deposit` WHERE `customer-id`= '$id'  ORDER by `id`DESC";
$resultdeposits = mysqli_query($db,$querydeposits);
$deposits =  mysqli_fetch_all($resultdeposits, MYSQLI_ASSOC);
mysqli_free_result($resultdeposits);


$querywithdraw = "SELECT * FROM `withdraw` WHERE `customer-id`= '$id'  ORDER by `id`DESC";
...
?>
            ...
            <div class="container-fluid">
                        ...
                        <div class="checkout-tabs">
                            <div class="row">
                                <div class="col-lg-2">
                                    ...
                                    <span class="nav-link active" id="v-pills-gen-ques-tab" data-toggle="pill"  role="tab" aria-controls="v-pills-gen-ques" aria-selected="true">
                                            <i class="bx bx-question-mark d-block check-nav-icon mt-4 mb-2"></i>
                                            <p class="font-weight-bold mb-4">User Details</p>
</span>
                                        <span class="nav-link jobs" id="v-pills-gen-ques-tab" data-toggle="pill"  role="tab" aria-controls="v-pills-gen-ques" aria-selected="true">
                                            <i class="bx bx-question-mark d-block check-nav-icon mt-4 mb-2"></i>
                                            <p class="font-weight-bold mb-4">Jobs</p>
                                        </span>
                                        <span class="nav-link deposit" id="v-pills-privacy-tab" data-toggle="pill" role="tab" aria-controls="v-pills-privacy" aria-selected="false"> 
                                            <i class="bx bx-check-shield d-block check-nav-icon mt-4 mb-2"></i>
                                            <p class="font-weight-bold mb-4">Deposits</p>
                                        </span>
                                        <span class="nav-link withdraw" id="v-pills-support-tab" data-toggle="pill" role="tab" aria-controls="v-pills-support" aria-selected="false">
                   ...
                   <table  class="table table-hover dt-responsive nowrap jobs-table" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                       <thead>
                           <tr>
                           ...
                           <?php endforeach   ?>
                                ...
                                <!-- END OF JOBS POSTED -->
                                  ...
                                  <div class="card" id="deposits">
                                        ...
                                        <h5>DEPOSITS MADE</h5>
                                        <div class="table-responsive">
                                        <table id="deposit-table" class="table table-hover dt-responsive nowrap " style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                       <thead>
                           <tr>
                       ...
                       <?php foreach ( $deposits as $deposit ):  ?>
                           ...
                           <td class="text-uppercase"><?php echo $deposit['trans-id']; ?></td>
                               <td class="text-capitalize"><?php echo $deposit['amount']; ?></td>
                               <td><?php echo $deposit['payment-mode']; ?></td>
                               <td><?php echo $deposit['cstatus']; ?></td>
                           ...
                           <?php endforeach   ?>
                                ...
                                <!-- END OF DEPOSITS POSTED -->
                                 ...
                                 <div class="card" id="withdraw">
                                        ...
                                        <h5>WITHDRAW MADE</h5>
                                        <div class="table-responsive">
                                        <table  class="table table-hover dt-responsive nowrap withdraw-table" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                       <thead>
                           <tr>
...
<script>
        $(document).ready(function() {
            ...
            $('#deposit-table').attr("id" ,"datatable");
            $('#deposits').show();
            $('#jobs').hide();
            $('#withdraw').hide();
