...
if(isset($_SESSION["profid"])){
   header("Location: p/professionals.php");

}  else if(isset($_SESSION["id"])){
    header("Location: u/professionals.php");

} else {}
/*
$sc_occ =$_SESSION['search_occupation'];
$sc_cou= $_SESSION['search_county'] ;
*/

$sc_occ = mysqli_real_escape_string($db, $_GET['occupation']);
$queryProfs = "SELECT * FROM `prof` where `occupation`= '$sc_occ'   ";
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Search Results for professionals <a href="professionals.php" class=" btn btn-sm ml-3 btn-outline-success" id="filter">VIEW ALL</a></h4>
<br>
                        ...
                        <?php
                                if (count($profs) == 0) {
                                    echo("Sorry, we don't have <b>".$sc_occ."</b> available right now <br><br>");
                                } else {
                                    # code...
                                }
