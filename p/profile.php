...
if(isset($_POST['changePassword'])){
    ...
    if($customers['password'] == md5($oldPassword)  &&  $newPassword == $confirmPassword){
        ...
        $query = "UPDATE `prof` SET `password` ='".md5($newPassword)."'  WHERE id = '$profid' ";
...
if(isset($_POST['updateServices'])){
    ...
    $services = mysqli_real_escape_string($db, $_POST['services']);    
     $query = "UPDATE `prof` SET `services` ='$services'  WHERE id = '$profid' ";
...
if(isset($_POST['updateAreas'])){
    ...
    $areas = mysqli_real_escape_string($db, $_POST['areas']);    
     $query = "UPDATE `prof` SET `areas` ='$areas'  WHERE id = '$profid' ";
...
if(isset($_POST['updateAbout'])){
    ...
    $about = mysqli_real_escape_string($db, $_POST['about']);    
     $query = "UPDATE `prof` SET `about` ='$about'  WHERE id = '$profid' ";
...
">
                        ...
                        <textarea name="services" id="" cols="65" rows="10"><?php echo $profs ["services"]; ?> </textarea><br>
                        <input class="btn btn-sm btn-success" type="submit" name="updateServices" value="Update">
                        </form>
                        </div>
                        <hr>
                                    
                        <div class="pl-3">
                        <h5>Summary about you</h5>
                        <form action="" method="POST">
                        <textarea name="about" id="" cols="65" rows="10"><?php echo $profs ["about"]; ?> </textarea><br>
                        <input class="btn btn-sm btn-success" type="submit" name="updateAbout" value="Update">     
                        </form>        
                        </div>
                        <hr>

                        <div class="pl-3">
                        <h5>The areas you cover</h5>
                        <form action="" method="POST">
                        <textarea name="areas" id="" cols="65" rows="10"><?php echo $profs ["areas"]; ?></textarea><br>
                        <input class="btn btn-sm btn-success" type="submit" name="updateAreas" value="Update">
                        </form>
    ...
    <hr>
                                            ...
                                            <h5 class="pl-3">Change Profile Picture</h5>
                                                ...
                                                <form action="../prof-pic.php" method="POST"  class="pl-3" enctype="multipart/form-data" >
                                                        ...
                                                        Upload Photo
                                                     <input class="form-control pl-3" type="file" name="uploadfiled" id="uploaded" >
                                                     <input type="hidden" class="pl-3" name="update_id" value="<?php echo $profs["id"]; ?>">

                                                     <input class="btn btn-sm btn-success pl-3" type="submit" name="submit-profpic">
                                                    </form>

<hr>

                                                    <h5 class="pl-3">Change Background Picture</h5>
