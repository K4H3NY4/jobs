...
<<<<<<< HEAD
    ...
    if($db->error){
        ...
        /***
         * 
         * your withdraw request of ksh xxx is being processed. we'll contact you shortly
         * 
         * * */

        $to = $profs['email'];
        $subject = "FUNDS WITHDRAW REQUEST";
        $message = " Your withdraw request of <b>Ksh " . $amount . "</b>  is being processed. We'll contact you shortly.";
...
<<<<<<< HEAD
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="wallet.php#profile1" role="tab" id="withdraws" aria-selected="false">
                                                    ...
                                                    <span class=" d-sm-block">JOBS TAKEN</span> 
                                                </a>
                                            </li>
