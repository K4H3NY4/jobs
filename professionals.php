...
=======
   header("Location: http://localhost/housing-jobs/p/professionals.php");

}  else if(isset($_SESSION["id"])){
    header("Location: http://localhost/housing-jobs/u/professionals.php");
...
=======
                               ...
                               <td class="text-capitalize"><?php echo $prof['occupation']; ?></td>
                               <td class="text-capitalize"><?php echo $prof['county']; ?></td>
                               <td><a class="btn btn-sm btn-primary" href="profile.php?id=<?php echo  base64_encode($prof['id']); ?>">View Profile</a></td>
>>>>>>> b888daa3ab3d6c7880f7e4f17cc79861e3914f2c
                           </tr>
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="card text-center">
                                    <div class="card-body">
                                        ...
                                        <h5 class="font-size-15"> <a href="profile.php?id=<?php echo  base64_encode($prof['id']); ?>" class="text-dark text-capitalize"><?php echo $prof['first-name'] ,' ' ,$prof['last-name']; ?> </a></h5>
                                        <p class="text-muted text-capitalize"><?php echo $prof['occupation']; ?></p>

                                        <div>
                                        <a href="profile.php?id=<?php echo  base64_encode($prof['id']); ?>" class="badge badge-primary font-size-11 m-1"><?php echo $prof['county']; ?></a>
                                    ...
                                    <div class="card-footer bg-transparent border-top">
                                        <div class="contact-links d-flex font-size-20">
                                            ...
                                            <div class="flex-fill">
                                            <a href="profile.php?id=<?php echo  base64_encode($prof['id']); ?>"data-toggle="tooltip" data-placement="top" title="" data-original-title="Profile"><i class="bx bx-user-circle"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
