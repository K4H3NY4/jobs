                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">My Job Posts</h4>
                                    ...
                                    <div class="card-body">
                                        <div class="media">
                                            <div class="avatar-md mr-4">
                                                <span class="avatar-title rounded-circle bg-light text-danger font-size-16" style="background-image: url('../<?php echo $task['photo'];?>');">
                                            ...
                                            <div class="media-body overflow-hidden">
                                                ...
                                                <p class="text-muted mb-4 text-capitalize"> <span class="font-weight-bold"> County :</span> <?php echo $task['county'];?> 
                                                <br> <span class="font-weight-bold">  Town : </span> <?php echo $task['town'];?> <br>
                                                <span class="font-weight-bold"> Posted On :</span>  <?php echo $task['time-created'];?></p>
                                    ...
                                    <div class="px-4 py-3 border-top">
                                        <ul class="list-inline mb-0">
                                            ...
                                            <li class="list-inline-item mr-3" data-toggle="tooltip" data-placement="top" title="" data-original-title="Budget">
                                                <i class= "bx bx-comment-dots mr-1"></i> <span class="font-bold font-italic">Ksh <?php echo $task['price'];?></span>
                                            </li>
